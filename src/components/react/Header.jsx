  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-30">
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-3 ml-auto flex-shrink-0">
              ...
              >
                <CartIcon />
                {itemCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs font-bold rounded-full w-5 h-5 md:w-6 md:h-6 flex items-center justify-center shadow-lg">
                    {itemCount}
                  </span>
                )}
              </button>
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 py-1.5 sm:py-2 md:py-3">
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
            <CategoryDropdown />
            <FilterDropdown />
            ...
            <button
              ...
              className={`flex items-center gap-0.5 sm:gap-1 md:gap-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 text-xs md:text-sm font-medium rounded-md transition-all whitespace-nowrap ${
