  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-30">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-1 xs:px-2 sm:px-4 py-1.5 xs:py-2 sm:py-3">
          <div className="flex items-center gap-0.5 xs:gap-1 sm:gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-0.5 xs:gap-1 sm:gap-2 md:gap-3 ml-auto flex-shrink-0">
              {/* Botón de búsqueda móvil */}
              <button
                className="md:hidden p-1 xs:p-1.5 sm:p-2 hover:bg-gray-100 rounded-full transition-colors flex-shrink-0"
              ...
              <button
                className="relative p-1 xs:p-1.5 sm:p-2 hover:bg-gray-100 rounded-full transition-colors flex-shrink-0"
                onClick={onCartClick}
                aria-label="Abrir carrito"
              >
                <CartIcon />
                {itemCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 xs:-top-1 xs:-right-1 bg-red-600 text-white text-[10px] xs:text-xs font-bold rounded-full w-4 h-4 xs:w-5 xs:h-5 md:w-6 md:h-6 flex items-center justify-center shadow-lg">
                    {itemCount}
                  </span>
                )}
              </button>
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-1 xs:px-2 sm:px-4 py-1 xs:py-1.5 sm:py-2 md:py-3">
          <div className="flex items-center gap-0.5 xs:gap-1 sm:gap-2 md:gap-4">
            <CategoryDropdown />
            <FilterDropdown />
            ...
            <button
              ...
              className={`flex items-center gap-0.5 xs:gap-1 md:gap-2 px-1.5 xs:px-2 sm:px-3 md:px-4 py-1 xs:py-1.5 sm:py-2 text-[10px] xs:text-xs md:text-sm font-medium rounded-md transition-all whitespace-nowrap ${
