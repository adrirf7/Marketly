  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-0.5 xs:gap-1 md:gap-2 px-1 xs:px-1.5 sm:px-3 md:px-4 py-0.5 xs:py-1 sm:py-2 text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition-colors whitespace-nowrap"
      >
